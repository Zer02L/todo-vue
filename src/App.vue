<template>
  <div id="app">
    <Header />
    <div class="alert alert-danger mx-3 mt-3" v-if="getError">
      {{ getError }}
    </div>
    <div class="alert alert-success mx-3 my-3" v-if="getIsSuccess">
      {{ getIsSuccess }}
    </div>
    ...
    <div class="mx-3" v-else>
      <div class="mainbox mt-3">
        <div class="title">
          <i class="fas fa-flag"></i> It's time to start now!
        </div>
        <div class="content">
